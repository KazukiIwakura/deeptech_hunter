...
重要: ビジネスモデルの説明、企業の説明文、技術概要、最新の進捗などは必ず日本語で回答してください。会社名は英語表記のままで構いません。
...
**4. 構造化レポートの生成 (Synthesize & Report):**
   ...
   - ビジネスモデル、技術概要、最新の進捗などの説明は必ず日本語で記述してください。
...
[
  {
    ...
    "summary": "企業が何をしているかを、その独自性を含めて具体的に説明するサマリー（日本語で記述）。",
    "fundingSourceUrl": "資金調達額を証明する最も信頼性の高い情報源のURL。見つからない場合は空の文字列 \"\" にしてください。",
    "business_model": "主要なビジネスモデルを日本語で説明（例：B2B向けハードウェア販売, SaaS, 技術ライセンスなど）。不明な場合は\"不明\"と記述。",
    "technology_summary": "競合と差別化する中核技術の簡単な説明を日本語で記述。不明な場合は\"不明\"と記述。",
    "key_investors": ["リードインベスターや著名なVCのリスト。見つからない場合は空配列 [] にしてください。"],
    "latest_milestone": "直近の重要なマイルストーンを日本語で説明（例：シリーズB調達完了, 製品の商業ローンチなど）。不明な場合は\"不明\"と記述。"
  }
]
\`\`\`
`;
